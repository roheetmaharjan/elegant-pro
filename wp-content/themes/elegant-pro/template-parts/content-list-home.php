...
?>
    <article id="post-<?php the_ID(); ?>" <?php post_class('post_content_article'); ?>>
        ...
        <div class="list-layout-home clearfix <?php if($i%5==0){echo " nomargin";} echo ' client-post-'.$i;?> wow fadeInUp" data-wow-delay="<?php echo $i*0.6;?>">
            <?php
                $bloggerbuz_img_src = wp_get_attachment_image_src( get_post_thumbnail_id(), 'bloggerbuz-list-thumb');
